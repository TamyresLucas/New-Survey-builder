...
export const ChoiceGridIcon: React.FC<IconProps> = ({ className, style }) => <MaterialSymbol icon="grid_view" className={className} style={style} fill={0} />;
...
export const DropDownIcon: React.FC<IconProps> = ({ className, style }) => <MaterialSymbol icon="dropdown" className={className} style={style} fill={0} />;
...
export const RunningTotalIcon: React.FC<IconProps> = ({ className, style }) => <MaterialSymbol icon="grid_view" className={className} style={style} fill={0} />;
