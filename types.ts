...
export enum QuestionType {
  ...
  Autocomplete = 'Auto Complete Dropdown',
  CardSort = 'Card Sort',
  CustomQuestion = 'Custom Scripting',
  DateTimeAnswer = 'Date & Time',
  DragAndDropRanking = 'Drag and Drop Ranking',
  DrillDown = 'Cascading Dropdown',
  DropDownList = 'Dropdown',
  EmailAddressAnswer = 'Email Address',
  FileUpload = 'File Upload',
  HybridGrid = 'Custom Grid',
  LookupTable = 'Lookup Table',
  NetPromoterNPS = 'NPS',
  NumericRanking = 'Numeric Ranking',
  NumericAnswer = 'Numeric Input',
  RespondentEmail = 'Email Collector',
  RespondentLanguage = 'Language Preference',
  RespondentMetadata = 'Metadata Collector',
  RespondentPhone = 'Phone Number',
  RespondentTimeZone = 'Time Zone',
  ...
  Timer = 'Timer',
  ImageSelector = 'Image Select',
  ImageChoiceGrid = 'Image Grid',
  Carousel = 'Carousel',
  ClickMap = 'Click Map',
