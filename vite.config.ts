...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    server: {
      port: 3000,
      host: '0.0.0.0',
      allowedHosts: ['liberal-sure-delegation-bacterial.trycloudflare.com', 'wax-refused-magazines-seminars.trycloudflare.com', 'pharmacy-offerings-suggesting-rounds.trycloudflare.com', 'forms-twice-herbal-pat.trycloudflare.com', 'duncan-since-occurs-obtaining.trycloudflare.com', '.modal.host'],
    },
